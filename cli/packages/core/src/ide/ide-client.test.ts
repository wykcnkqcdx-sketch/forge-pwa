...
describe('IdeClient', () => {
  ...
  beforeEach(async () => {
    ...
    process.env['BLACKBOX_CODE_IDE_WORKSPACE_PATH'] = '/test/workspace';
    delete process.env['BLACKBOX_CODE_IDE_SERVER_PORT'];
    delete process.env['BLACKBOX_CODE_IDE_SERVER_STDIO_COMMAND'];
    delete process.env['BLACKBOX_CODE_IDE_SERVER_STDIO_ARGS'];
  ...
  describe('connect', () => {
    it('should return invalid if BLACKBOX_CODE_IDE_WORKSPACE_PATH is undefined', () => {
    ...
    it('should return invalid if BLACKBOX_CODE_IDE_WORKSPACE_PATH is empty', () => {
      const result = IdeClient.validateWorkspacePath(
        '',
        'VS Code',
        '/Users/person/gemini-cli/sub-dir',
    ...
    it('should connect using HTTP when port is provided in config file', async () => {
      ...
      expect(fs.promises.readFile).toHaveBeenCalledWith(
        path.join('/tmp', 'blackbox-cli-ide-server-12345.json'),
        'utf8',
      );
    ...
    it('should connect using HTTP when port is provided in environment variables', async () => {
      ...
      process.env['BLACKBOX_CODE_IDE_SERVER_PORT'] = '9090';
    ...
    it('should connect using stdio when stdio config is in environment variables', async () => {
      ...
      process.env['BLACKBOX_CODE_IDE_SERVER_STDIO_COMMAND'] = 'env-cmd';
      process.env['BLACKBOX_CODE_IDE_SERVER_STDIO_ARGS'] = '["--bar"]';
