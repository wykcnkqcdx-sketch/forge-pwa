  ...
  parametersJsonSchema: {
    ...
    properties: {
      ...
      scope: {
        type: 'string',
        description:
          'Where to save the memory: "global" saves to user-level ~/.blackboxcli/BLACKBOX.md (shared across all projects), "project" saves to current project\'s BLACKBOX.md (project-specific). If not specified, will prompt user to choose.',
        enum: ['global', 'project'],
      },
    },
    required: ['fact'],
...
- \`scope\` (string, optional): Where to save the memory:
  - "global": Saves to user-level ~/.blackboxcli/BLACKBOX.md (shared across all projects)
  - "project": Saves to current project's BLACKBOX.md (project-specific)
  - If not specified, the tool will ask the user where they want to save the memory.
`;

export const GEMINI_CONFIG_DIR = '.blackboxcli';
export const DEFAULT_CONTEXT_FILENAME = 'BLACKBOX.md';
export const MEMORY_SECTION_HEADER = '## Blackbox Added Memories';

// This variable will hold the currently configured filename for BLACKBOX.md context files.
