...
export enum ToolErrorType {
  ...
  BROWSER_NAVIGATE_ERROR = 'browser_navigate_error',
  BROWSER_CLICK_ERROR = 'browser_click_error',
  BROWSER_TYPE_ERROR = 'browser_type_error',
  BROWSER_SCROLL_ERROR = 'browser_scroll_error',
