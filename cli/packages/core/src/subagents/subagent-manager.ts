...
const BLACKBOX_CONFIG_DIR = '.blackboxcli';
...
export class SubagentManager {
  ...
  getSubagentPath(name: string, level: SubagentLevel): string {
    ...
    const baseDir =
      level === 'project'
        ...
        : path.join(os.homedir(), BLACKBOX_CONFIG_DIR, AGENT_CONFIG_DIR);
  ...
  private async listSubagentsAtLevel(
    ...
    baseDir = path.join(baseDir, BLACKBOX_CONFIG_DIR, AGENT_CONFIG_DIR);
