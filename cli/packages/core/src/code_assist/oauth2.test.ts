...
describe('oauth2', () => {
  ...
  describe('in Cloud Shell', () => {
    ...
    it('should attempt to load cached credentials first', async () => {
      ...
      const credsPath = path.join(tempHomeDir, BLACKBOX_DIR, 'oauth_creds.json');
  ...
  describe('clearCachedCredentialFile', () => {
    ...
    it('should handle Blackbox module clearing gracefully', async () => {
      // This test verifies that clearCachedCredentialFile doesn't throw
      // when Blackbox modules are available and can be cleared
      ...
      // The actual Blackbox clearing logic is tested separately in the Blackbox module tests
    });
