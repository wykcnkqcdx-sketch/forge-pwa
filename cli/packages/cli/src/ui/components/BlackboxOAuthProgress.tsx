...
interface BlackboxOAuthProgressProps {
  onTimeout: () => void;
  onCancel: () => void;
...
export function BlackboxOAuthProgress({
  onTimeout,
  onCancel,
  deviceAuth,
  authStatus,
  authMessage,
}: BlackboxOAuthProgressProps): React.JSX.Element {
    ...
    return (
      ...
      >
        <Text bold color={Colors.AccentRed}>
          Blackbox OAuth Authentication Timeout
        </Text>
  ...
  if (!deviceAuth) {
    return (
      ...
      >
        <Box>
          <Text>
            <Spinner type="dots" /> Waiting for Blackbox OAuth authentication...
          </Text>
        </Box>
        <Box marginTop={1} justifyContent="space-between">
          <Text color={Colors.Gray}>
