...
import type { Config, FileSearch } from '@blackbox_ai/blackbox-cli-core';
import { FileSearchFactory } from '@blackbox_ai/blackbox-cli-core';
import type { FileSystemStructure } from '@blackbox_ai/blackbox-cli-test-utils';
