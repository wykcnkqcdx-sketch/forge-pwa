...
import { type DetectedIde, getIdeInfo } from '@blackbox_ai/blackbox-cli-core';
...
export function IdeIntegrationNudge({
  ...
  const isExtensionPreInstalled =
    !!process.env['BLACKBOX_CODE_IDE_SERVER_PORT'] &&
    ...
    >
      <Box marginBottom={1} flexDirection="column">
        <Text>
          ...
          {`Do you want to connect ${ideName ?? 'your editor'} to Blackbox Code?`}
        </Text>
