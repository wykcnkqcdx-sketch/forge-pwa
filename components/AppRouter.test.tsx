...
vi.mock('../screens/LogbookScreen', () => ({ LogbookScreen: () => <span>LogbookScreen</span> }));
vi.mock('../screens/RoutePlannerScreen', () => ({ RoutePlannerScreen: () => <span>RoutePlannerScreen</span> }));
vi.mock('../screens/RuckRingScreen', () => ({ RuckRingScreen: () => <span>RuckRingScreen</span> }));
...
const mockUseApp = {
  ...
  cloud: { authReady: true, cloudStatus: 'local', authLoading: false, authError: '', signInWithEmail: vi.fn(), signUpWithEmail: vi.fn(), cloudSession: null, syncCloudNow: vi.fn(), revokeCloudInvite: vi.fn(), signOutCloud: vi.fn(), exportGoogleSheetsNow: vi.fn(), googleSheetsExporting: false, googleSheetsMessage: '', cloudTeamActivity: [], cloudInvites: [] },
