...
const styles = StyleSheet.create({
  cardTitle: { ...typography.h4, color: colours.text, marginBottom: responsiveSpacing('md') },
  assignmentLabel: { ...typography.label, color: colours.muted, marginBottom: responsiveSpacing('xs') },
  ...
  assignmentPillText: { ...typography.label, color: colours.muted },
  assignmentPillTextActive: { color: colours.cyan },
  programmeCopy: { ...typography.caption, color: colours.textSoft, lineHeight: 19, marginBottom: responsiveSpacing('md') },
  ...
  programmeText: { ...typography.caption, color: colours.text, lineHeight: 19, fontWeight: '800' },
  programmeMeta: { ...typography.caption, color: colours.textSoft, lineHeight: 18, marginTop: responsiveSpacing('sm') },
  ...
  programmeScienceBullet: { ...typography.caption, color: colours.cyan, fontWeight: '900', marginTop: 1 },
  programmeScienceText: { flex: 1, ...typography.caption, color: colours.textSoft, lineHeight: 18, fontWeight: '800' },
  ...
  programmeExerciseName: { ...typography.caption, color: colours.text, fontWeight: '900' },
  programmeExerciseDose: { ...typography.label, color: colours.muted, marginTop: 4 },
  ...
  stageRemoveText: { ...typography.caption, color: colours.red, fontWeight: '900' },
  ...
  templateActionText: { ...typography.caption, color: colours.cyan, fontWeight: '900' },
});