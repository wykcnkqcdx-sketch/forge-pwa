            ...
            <Pressable
              ...
              style={[
                styles.modeTab,
                {
                  ...
                  backgroundColor: isActive ? `${mode.tone}18` : colours.surface,
                },
              ]}
...
const styles = StyleSheet.create({
  ...
  lockedTab: { borderColor: colours.borderSoft, backgroundColor: 'transparent', gap: 6 },
  lockedText: { color: colours.soft, fontWeight: '900' },
  lockedBarBg: { width: 32, height: 4, backgroundColor: colours.borderSoft, borderRadius: 2, overflow: 'hidden' },
  ...
  primaryButtonText: { color: colours.background, fontWeight: '900' },
  ...
  progPill: { borderWidth: 1, borderColor: colours.borderSoft, borderRadius: 999, paddingHorizontal: 13, paddingVertical: 7, backgroundColor: colours.surface },
  ...
  progResult: { marginTop: 22, gap: 14, borderTopWidth: 1, borderTopColor: colours.borderSoft, paddingTop: 18 },
  ...
  progDayCardOpen: { backgroundColor: colours.layer2 },
