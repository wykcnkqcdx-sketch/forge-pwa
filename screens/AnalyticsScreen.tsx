      ...
      <Card>
        ...
        <LineChart
          ...
          chartConfig={{
            ...
            decimalPlaces: 0,
            color: (opacity = 1) => `rgba(198, 161, 91, ${opacity})`,
...
const styles = StyleSheet.create({
  ...
  trendToggle: { flexDirection: 'row', backgroundColor: colours.layer2, borderRadius: 8, padding: 2 },
  ...
  factorItem: { width: '23%', flexGrow: 1, backgroundColor: colours.surface, borderRadius: 8, paddingVertical: responsiveSpacing('sm'), alignItems: 'center' },
  ...
  filterPill: { borderWidth: 1, borderColor: colours.borderSoft, borderRadius: 6, paddingHorizontal: 12, paddingVertical: 6, backgroundColor: colours.surface },
  filterText: { ...typography.label, color: colours.muted, letterSpacing: 0.5, fontWeight: '800' },
  filterTextActive: { color: colours.cyan },
  logEmptyState: { alignItems: 'center', gap: 6, borderWidth: 1, borderColor: colours.borderSoft, borderRadius: 16, padding: responsiveSpacing('lg'), backgroundColor: colours.panel },
  ...
  bodyInput: { borderWidth: 1, borderColor: colours.borderSoft, borderRadius: 8, color: colours.text, backgroundColor: colours.inputBg, paddingHorizontal: 12, paddingVertical: 10, fontSize: 16, fontWeight: '900' },
  ...
  exerciseBarBg: { width: 80, height: 6, borderRadius: 3, backgroundColor: colours.borderSoft },
